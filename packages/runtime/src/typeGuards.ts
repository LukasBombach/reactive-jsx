import type { Tag, Component, Element, Child, R } from "./createElement";
...
export const isVoidChild = (value: unknown): value is boolean | null | undefined =>
  isBoolean(value) || isNull(value) || isUndefined(value);

export const isReactiveChild = (value: R<Child>): value is () => Child => typeof value === "function";
